...
<body>
  <header class="header header__open-burger-menu">
    <div class="container header__container flex">
      <button id="burger" class="header__burger btn-reset">
        <span class="burger__line"></span>
        <span class="burger__line"></span>
        <span class="burger__line"></span>
      </button>
      <a class="header__logo logo" href="/">
        <img class="logo__image" src="../img/logo-lagoona-1920.svg" alt="logo Lagoona">
      </a>
      <nav class="nav header__nav flex">
        <ul class="nav__list list-reset flex">
          <li class="nav__item">
            <a class="nav__link" href="#placement">Отели</a>
          </li>
          <li class="nav__item">
            <a class="nav__link" href="#application">Оставить заявку</a>
          </li>
          <?php if (isset($_SESSION['user_id'])): ?>

          <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
            <li class="nav__item">
              <a class="nav__link" id="user" href="#">Admin</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" id="role" href="#">[ Admin ]</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" href="/adminPanel">Панель администратора</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" href="/admin/hotels">Управление отелями</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" href="/admin/requests">Заявки</a>
            </li>
          <?php else: ?>
            <li class="nav__item">
              <a class="nav__link" id="user" href="#">Гость</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" id="role" href="#">[ Гость ]</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" href="/dashboard">Мои брони</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" href="/requests">Мои заявки</a>
            </li>
          <?php endif; ?>

          <li class="nav__item">
            <a id="logoutBtn" class="nav__link" href="#">Выход</a>
          </li>
          ...
          <li class="nav__item">
            <a class="nav__link" href="/register">Регистрация</a>
          </li>
        ...
        <div class="footer__content flex">
          <div class="footer__left-block">
            <a class="footer__logo logo" href="#">
              <img class="logo__image" src="../img/logo-lagoona-1920.svg" alt="Евклид">
            </a>
            <nav class="nav footer__nav">
              <ul class="nav__list list-reset flex">
                ...
                <li class="nav__item">
                  <a class="nav__link" href="#question">Отзывы</a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="#about-us">Договор оферты</a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="#about-us">Договор подряда</a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="#about-us">Конфиденциальность</a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="#about-us">Партнёрское соглашение</a>
                </li>
              </ul>
            </nav>
            <ul class="footer__social flex list-reset">
              <li class="footer__social-item">
                <a class="footer__social-link" href="#">
                  <svg class="footer__svg" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
          ...
          <div class="footer__center-block">
            <h2 id="application" class="footer__title title">Оставить заявку</h2>
            <form id="requestForm" class="form flex">
              <input class="form__input" required type="text" name="name" placeholder="ФИО*">
              <input class="form__input" required type="email" name="email" placeholder="Email*">
              <input class="form__input" required type="tel" name="tel" placeholder="Телефон*">
              <textarea class="form__textarea" name="message" placeholder="Сообщение"></textarea>
              <div class="form__label">
                <button type="submit" class="footer__btn btn btn-reset">Отправить данные</button>
                <label class="custom-checkbox">
                  <input class="form__label-input" required type="checkbox">
                  <span class="form__label-text">Согласен на обработку данных</span>
                </label>
              </div>
              <p id="requestResult" class="error"></p>
            </form>
          </div>
            <p class="footer__descr descr">
              Высокий уровень вовлечения представителей
              целевой аудитории является чётким доказательством
              простого факта: разбавленное изрядной долей эмпатии,
              рациональное мышление позволяет оценить значение модели
